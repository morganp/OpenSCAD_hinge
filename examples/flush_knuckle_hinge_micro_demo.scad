...
flush_knuckle_hinge(
    ...
    back_relief       = 0.35,  // top-face trim depth at the hinge line, frees swing past 90 degrees
    back_relief_width = 0.1,   // trim band width; rest of the knuckle stays full height
    integral_pin      = true,
